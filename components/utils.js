...
class Utils {
    ...
    static isFilledArray = (arr) => Array.isArray(arr) && arr.length > 0;

    static isHtmlEmpty(html) {
    ...
    static parseInt = (value) => {
        let resultValue = 0;
        if (value) resultValue = parseInt(value);
        return resultValue;
    };

    // static getScale(x, base) {
